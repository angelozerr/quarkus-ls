...
public class QuteCompletionInUserTagTest {
	...
	public void specialKeys() throws Exception {
		...
		testCompletionFor(template, //
				...
				c("inject:bean : String", "inject:bean", r(1, 1, 1, 1)), //
		...
		testCompletionFor(template, //
				...
				"tags/form", //
				3 /* item, inject:bean, config:getConfigProperty */ + 2 /* it, nested-content */, //
				c("item", "item", r(1, 1, 1, 1)), //
				c("inject:bean : String", "inject:bean", r(1, 1, 1, 1)), //
				c("config:getConfigProperty(propertyName : String) : Object",
						"config:getConfigProperty(propertyName)", r(1, 1, 1, 1)), //
				c("it", "it", r(1, 1, 1, 1)), //
