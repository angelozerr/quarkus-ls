...
public abstract class AbstractPropertiesProvider implements IPropertiesProvider {
	 ...
	 *         name.
	 */
	protected static SearchPattern createAnnotationSearchPattern(String annotationName) {
	 ...
	 */
	protected static SearchPattern createClassSearchPattern(String className) {
		return SearchPattern.createPattern(className, IJavaSearchConstants.CLASS, IJavaSearchConstants.DECLARATIONS,
