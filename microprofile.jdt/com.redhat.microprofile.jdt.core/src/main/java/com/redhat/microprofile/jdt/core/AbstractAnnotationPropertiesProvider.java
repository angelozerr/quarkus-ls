 ...
 *
 */
public abstract class AbstractAnnotationPropertiesProvider extends AbstractPropertiesProvider {

	private static final Logger LOGGER = Logger.getLogger(AbstractAnnotationPropertiesProvider.class.getName());
	...
	protected SearchPattern createSearchPattern(String annotationName) {
		return createAnnotationSearchPattern(annotationName);
	}
